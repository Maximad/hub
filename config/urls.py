...
urlpatterns = [
    ...
    path('staff/finance/transfers/<int:transfer_id>/', staff_transfer_detail, name='staff_transfer_detail'),
    path('staff/finance/transfers/<int:transfer_id>/reverse/', staff_transfer_reverse, name='staff_transfer_reverse'),
