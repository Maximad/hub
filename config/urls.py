...
urlpatterns = [
    ...
    path('staff/reports/stock-deduction/', staff_inventory.staff_stock_deduction_report, name='staff_stock_deduction_report'),
    path('staff/reports/waste/', staff_inventory.staff_waste_report, name='staff_waste_report'),
    path('staff/prep/batches/', staff_inventory.staff_prep_batches, name='staff_prep_batches'),
    path('staff/prep/batches/new/', staff_inventory.staff_prep_batch_new, name='staff_prep_batch_new'),
    path('staff/prep/batches/<int:batch_id>/', staff_inventory.staff_prep_batch_detail, name='staff_prep_batch_detail'),
