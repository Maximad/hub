...
EXAMPLES = {
    'purchases': ['CREATE_DRAFT', 'غير مراجع', 'PUR-EXAMPLE-001', '2026-01-15', '', 'اسم المورد', 'INV-001', '0', 'مثال فقط'],
    'purchase_items': ['CREATE', 'LINE-EXAMPLE-001', 'PUR-EXAMPLE-001', 'ING-COFFEE', 'بن', '1', 'kg', '10000', ''],
    'order_payments': ['COLLECT', 'مراجع', 'PAY-EXAMPLE-001', '2026-01-15', '00000000-0000-0000-0000-000000000000', '#00001', '5000', 'cash', '', 'مثال فقط'],
    'inventory': ['CREATE_INACTIVE', 'غير مراجع', 'ING-EXAMPLE', 'مادة مثالية', 'Example', 'ingredient', 'kg', '1', '0', '', ''],
    'recipes': ['UPSERT_INACTIVE', 'غير مراجع', 'PRODUCT-KEY', 'اسم المنتج', 'ING-EXAMPLE', 'مادة مثالية', '10', 'g', '0', ''],
}
