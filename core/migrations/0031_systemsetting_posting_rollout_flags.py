...
class Migration(migrations.Migration):
    ...
    operations = [
        migrations.AddField(model_name='systemsetting', name='posting_ledger_writes_enabled', field=models.BooleanField(default=False, verbose_name='كتابة القيود المالية الجديدة')),
